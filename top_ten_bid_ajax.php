...
$uuid=$clct_clt_bdr_dtl['uid'];
 ...
 $bdr_bid_bld="select * from livebidding where salenotice_id='$sls_id' and bidder_fid='$bdr_iid' and highestBid='$amnnt'";
$qst_bdr_bid_bld=$db->query($bdr_bid_bld);
$bdr_ftch_bd=$qst_bdr_bid_bld->fetch_assoc();
$bdr_hgst_bbd=$bdr_ftch_bd['highestBid'];
?>
<?php 
if($bdr_hgst_bbd==$amnnt)
{
?>
<tr>
                                  <th scope='row'><?php echo $sno++;?></th>
                                  <!--<td><?php echo $uuid;?></td>-->
                                  <td style="color:green"><?php echo $nbr_of_extntn;?></td>
                                  <td style="color:green"><?php echo $amnnt;?></td>
                                  <td style="color:green"><?php echo number_to_word($amnnt);?></td>
                                  </tr>
                            <?php 
}
else
