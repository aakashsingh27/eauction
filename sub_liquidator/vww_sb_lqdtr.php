...
$iiid=$clct_usr_lst['id'];
    ...
    ?><tr>
        ...
        <td>
    <a href='update_sb_lqdtr.php?id=<?php echo $iiid;?>' class='btn btn-primary' style="
    width: 100%;">Edit</a> 
    
    <a href='dlt_sb_lqdtr.php?id=<?php echo $iiid;?>' class='btn btn-danger' style="
    width: 100%;margin-top:5px;">Delefe</a> 
