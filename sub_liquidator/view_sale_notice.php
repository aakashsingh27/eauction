...
$typ_of_prprty_id=$title=$clct_usr_lst['property_type'];
...
$cmpny_id=$clct_usr_lst['super_company_name'];
...
$clt_cmp_dtl="select * from display_company where id='$cmpny_id'";
...
$cmpy_nem=$clct_clt_cmp_dtl['company_name'];
    ...
    width: 100%;
">Edit</a> <br><br><a href='delete_sale_notice.php?id=<?php echo $sl_ntc_id;?>' onclick="return confirm('Are you sure want to delete this sales Notice ?')" class='btn btn-danger'>Delete</a> <br><br><a href='sale_notice_pdf/<?php echo $pdf_file;?>'>View PDF</a></td> -->
