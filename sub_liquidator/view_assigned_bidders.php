...
$cmp_nem=$clct_clt_cmp_dtl['company_name'];
    ...
    ?><tr>
        ...
        <td><a href='edit_assgned_bdder.php?id=<?php echo $iiidd;?>' class='btn btn-primary'>Edit</a> <a href='delete_assgned_bdder.php?id=<?php echo $iiidd;?>' class='btn btn-danger'>Delete</a></td>
