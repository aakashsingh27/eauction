...
<input type="text" name="bdr_nem" value="<?php echo $bdr_nem;?>"  class="form-control"  placeholder="Enter name" required style="border:1px solid black !important;">
</div>
...
<input type="email" name="bdr_emnl"  value="<?php echo $bdr_emnl;?>" class="form-control"  placeholder="Enter Bidder email" required style="border:1px solid black !important;">
</div>
...
<input type="number" name="bdr_mbl"  class="form-control" value="<?php echo $bdr_mnbl;?>" placeholder="Enter Bidder mobile" required style="border:1px solid black !important;">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Bidder password</label>
<input type="text" name="bidr_pwd"  class="form-control" value="<?php echo $bdr_pswd;?>"  placeholder="Enter Bidder password" required style="border:1px solid black !important;">
</div>
...
<input type="text" name="uid"  class="form-control" value="<?php echo $bdr_uid;?>"  placeholder="Enter Bidder uid" required style="border:1px solid black !important;">
</div>
