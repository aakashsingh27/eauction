...
<input type="text" name="bdr_nem"   class="form-control"  placeholder="Enter Name" required style="border:1px solid black !important;">
</div>
...
<input type="email" name="bdr_emnl"  class="form-control"  placeholder="Enter Email" required style="border:1px solid black !important;">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Bidder UID</label>
<input type="number" name="bdr_uid"  min='0' class="form-control"  placeholder="Enter Bidder UID" required style="border:1px solid black !important;">
</div>
...
<input type="number" name="bdr_mbl"   min='0'  class="form-control"  placeholder="Enter Bidder Mobile" required style="border:1px solid black !important;">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Bidder Password</label>
<input type="password" name="bidr_pwd"  class="form-control"  placeholder="Enter Bidder Password" required style="border:1px solid black !important;">
</div>
