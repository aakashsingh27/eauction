...
$mail->AddAddress("$bdr_emnl");
//$mail->AddReplyTo("mail@mail.com");

$mail->IsHTML(true);

$mail->Subject = "IP Support (Login Credentials)--Date-time ($crt_det_tme)";
...
<p3><b>Password :- </b>$gnrt_pwd</p3><br><br>
...
echo "<script>window.alert('Your Credentials sent on your mail please check');window.location='index.php';</script>";
