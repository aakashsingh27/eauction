...
$clt_stet_dtl="select * from state where id='$stett_id'";
...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Edit State</li>
</ol>
...
<input type='text' value="<?php echo $stet_nem;?>" placeholder='Enter State name' name="stet" class="form-control" required style="border:1px solid black !important;">
</div>
...
`state_name`='$setet_nem' where id='$stett_id'";
