...
<?php 
$clt_cmp_dtl="select * from display_company";
...
<h5 style="font-weight:bold;"> Do you want to assign display company to liquidator ?</h5>
</div>

<!-- Modal footer -->
<div class="modal-footer">
<button type="submit" class="btn btn-warning" name="sbt_without_email" >Submit </button> <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
</div>
...
$slt_dplc_dtl="select * from assign_display_company_liquidator where company_id='$cmep_id' and liquidator_id='$lqdtr_id'";
...
$ad_prdt="insert into assign_display_company_liquidator set
company_id='$cmep_id',
