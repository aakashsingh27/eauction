...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Contact us</li>
</ol>
...
<th style="border-bottom:2px solid black !important;">Subject</th>
...
<tbody>
    <?php 
    $usr_lst="select * from contact_us ";
    $qst_usr_lst=$db->query($usr_lst);
    $sno=1;
    while($clct_usr_lst=$qst_usr_lst->fetch_assoc())
    {
        $lqdtr_nem=$clct_usr_lst['name'];
        $lqdtr_emnl=$clct_usr_lst['email'];
        $lqdtr_pwd=$clct_usr_lst['subject'];
        $lqdtr_adrs=$clct_usr_lst['message'];
