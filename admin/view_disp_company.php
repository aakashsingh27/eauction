...
<!--<h2 class="mt-30 page-title">All display company</h2>-->
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">All display company</li>
</ol>
...
<tbody>
    <?php 
    $usr_lst="select * from display_company ";
...
<td><a href='edit_disp_company.php?id=<?php echo $cmp_id;?>' class='btn btn-primary'>Edit</a> <a href='delt_disp_company.php?id=<?php echo $cmp_id;?>'  onclick="return confirm('Are you sure want to delete this display company?')" class='btn btn-danger'>Delete</a></td>
