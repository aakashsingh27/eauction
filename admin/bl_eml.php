...
$mail->Host = 'akoneseo.com';		//Sets the SMTP hosts of your Email hosting, this for Godaddy
$mail->Port = '587';								//Sets the default SMTP server port
$mail->SMTPAuth = true;							//Sets SMTP authentication. Utilizes the Username and Password variables
$mail->Username = 'mailclass-FGDhjAEmAH@ipsupport.in';					//Sets SMTP username
$mail->Password = '019310Aakash';					//Sets SMTP password
