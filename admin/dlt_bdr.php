...
if($assgn_ccnt > 0)
{
    echo "<script>window.alert('This bidder found in assign_bidders_by_liquidator table please delete first from here.');window.location='view_bdrs.php';</script>";
}
else if($live_bidding_ccnt > 0)
{
    echo "<script>window.alert('This bidder found in livebidding table please delete first from here.');window.location='view_bdrs.php';</script>";
}
else if($exstng_bidding_ccnt > 0)
{
     echo "<script>window.alert('This bidder found in existing_bidders_request table please delete first from here.');window.location='view_bdrs.php';</script>";
}
...
if($qst_dtl_bdr)
{
    echo "<script>window.alert('Bidder Deleted successfully');window.location='view_bdrs.php';</script>";
