...
<!--<h2 class="mt-30 page-title">Assigned Company To Liquidator</h2>-->
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Assigned Company To Liquidator</li>
</ol>
...
<tbody>
    <?php 
    $usr_lst="select * from assign_liquidator ";
    ...
    while($clct_usr_lst=$qst_usr_lst->fetch_assoc())
    {
        ...
        $lqdtr_id=$clct_usr_lst['liquidator_id'];
         $assign_id=$clct_usr_lst['id'];
         $emnl_set_stes=$clct_usr_lst['email_sent_status'];
...
<td><?php if($emnl_set_stes!=NULL) { echo $emnl_set_stes; } else { echo "Not sent"; }?></td>
<td><a href='edit_assgn.php?id=<?php echo $assign_id;?>' class='btn btn-primary'>Edit</a> <a href='delt_assgn.php?id=<?php echo $assign_id;?>' onclick="return confirm('Are you sure want to unassigned company to this liquidator?')" class='btn btn-danger'>Delete</a></td>
