...
<li class="breadcrumb-item active">Sales Notice</li>
</ol>
...
<th>Increamental price</th>
<th>Buffer Time (in minutes)</th>
<th>Start auction date</th>
<th>End auction date</th>
<th>Live Bid details</th>
<th>Bid details</th>
<th>Bid Report</th>
   ...
   <tbody>    
    <?php 
    $usr_lst="select * from create_sale where create_by_liquiditor_id='$liquidator_id'";
