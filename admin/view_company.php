...
<!--<h2 class="mt-30 page-title">All Company</h2>-->
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">All Company</li>
</ol>
...
<th style="border-bottom:2px solid black !important;">Address</th>
...
<tbody>
    <?php 
    $usr_lst="select * from company ";
    $qst_usr_lst=$db->query($usr_lst);
    $sno=1;
    while($clct_usr_lst=$qst_usr_lst->fetch_assoc())
    {
        $cmp_nem=$clct_usr_lst['company_name'];
        $cmp_adrs=$clct_usr_lst['address'];
      $cmp_id=$clct_usr_lst['id'];
...
<td><?php echo $cmp_adrs;?></td>
<td><a href='edit_company.php?id=<?php echo $cmp_id;?>' class='btn btn-primary'>Edit</a> <a href='delt_company.php?id=<?php echo $cmp_id;?>'  onclick="return confirm('Are you sure want to delete this company?')" class='btn btn-danger'>Delete</a></td>
