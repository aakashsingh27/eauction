...
<!--<h2 class="mt-30 page-title">Started Soon</h2>-->
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;"
>Started Soon</li>
</ol>
...
<div class='row'>
    ...
    <div class='col-md-6'>
        ...
        <select name='lqdtr' class='form-control' required style="border:1px solid black !important;">
    ...
    <div class='col-md-6'>
    <label>.</label><br>
<button type='submit' name='srch' class='btn btn-primary' style="color: white !important;font-weight: bold !important;">Search</button>    <button type="button" class="btn btn-warning" onclick="window.history.back()">Back</button>
        </div>
...
<?php 
    ...
    $clt_sel_notc_dtl="select * from create_sale where create_by_liquiditor_id='$liquidator_id' and End_Date_Auction > '$timestamp' and Start_Date_Auction > '$timestamp'";
    $qst_clt_sel_notc_dtl=$db->query($clt_sel_notc_dtl);
...
else if($sel_netc_cnt==0)
{
   
    echo "<h3 style='color:red;font-weight:bold'>Result not found</h3>";
}
?>
