...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Add Company</li>
</ol>
<div class="container-fluid">
...
<input type="text" name="cmp_adrs"  class="form-control"  placeholder="Enter company address" maxlength="150" style="border:1px solid black !important;" required>
</div>
...
$ad_prdt="insert into company set
company_name='$ttel',
address='$lqdtr_eml'";
...
if($qst_ad_prdt)
{
echo "<script>window.alert('company Added Successfully');window.location='view_company.php';</script>";
