...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Assigned Display Company To Liquidator</li>
</ol>
...
<tbody>
    <?php 
    $usr_lst="select * from assign_display_company_liquidator ";
...
$clt_cmp_dtl="select * from display_company where id='$cmp_id'";
...
<td> <a href='delt_assgn_disp_cmpny.php?id=<?php echo $assign_id;?>' onclick="return confirm('Are you sure want to unassigned company to this liquidator?')" class='btn btn-danger'>Unassign</a></td>
