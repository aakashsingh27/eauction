...
$mail->Subject = "IP Support (Liquidator Credentials)--Date-time ($crt_det_tme)";
$mail->Body = "<p3>Dear Ma’am/Sir,</p3><br><br>
<p3>Greeting of the day !!</p3><br><br>
<p3>Here is your login credentials for Liquidator panel. </p3><br><br>
<p3><a href='https://eauction.ipsupport.in/liquidator/login.php'>Click here - (Link)</a></p3><br><br>
<p3><span style='font-weight:bold'>Username :- </span> <span>$lqdtr_eml</span></p3><br><br>
<p3><span style='font-weight:bold'>Password :- </span> <span>$lqdtr_pswd</span></p3><br><br>
