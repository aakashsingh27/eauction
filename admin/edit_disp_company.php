...
$clt_dtl="select * from display_company where id='$cmp_id'";
...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Edit display company</li>
</ol>
<div class="container-fluid">
...
<button type='submit' name="submit" class='btn btn-primary'>Submit</button> <a href="view_disp_company.php" class="btn btn-warning">Back</a>
</div>
</div>
</form>
...
$ad_prdt="update display_company set
company_name='$ttel' where id='$cmp_id'";

$qst_ad_prdt=$db->query($ad_prdt);

if($qst_ad_prdt)
{
echo "<script>window.alert('company updated successfully.');window.location='view_disp_company.php';</script>";
