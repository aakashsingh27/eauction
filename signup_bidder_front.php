...
<div class="container ">
  ...
  <div class="row d-flex justify-content-center">
    <div class="col-md-5 bg-light p-5 mt-3 mb-3" style="border-radius: 50px 50px; border:2px solid orange">
      <form action="" method="POST">
            <div class="section-title">
              <span><strong><h4>BIDDER Signup </h4></strong></span>
            </div>  
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label"> UID <span style="font-size:12px">*(Aadhar card, Pancard, Passport, Drive License)</span></label>
...
<div class='row'>
 ...
 <div class="mb-3 col-md-6">
    ...
    font-weight: bold;
    font-family: unset;
"> <?php echo $cptcha_ced;?></span> <a href='' class='btn btn-success'><i class="fa fa-refresh" aria-hidden="true"></i></a>
<input type="hidden" value="<?php echo $cptcha_ced;?>" name="generacptcha">
