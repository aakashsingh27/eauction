...
<a href="#" onclick="asdsd();" class="btn  btn-primary" style="float:right">Generate PDF</a><br>
</div>
<div id='bdr_report'>
...
<h5 style="float:right;font-weight:bold;">SABRE EDGE IT SOLUTIONS</h5><br>
...
<h3 style="padding-top:15px;">Auction Details :</h3>
</div>
...
<?php echo '<div style="margin-top:15px;"><h3 style="padding-top:15px;">Winner Details:</h3></div>
<div class="col-md-12 table table-responsive"> 
...
<span><b>Note :-</b> This is system generated auction details on safe and protected platform provided by Sabre Edge IT
Solutions.</span>
</div>
</div>
