...
<input type="text" name="ttle"  class="form-control"  placeholder="Enter Liquitor name">
</div>
...
<input type="email" name="lqditor_emnl"  class="form-control"  placeholder="Enter Liquitor Email">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Liquiditor Password</label>
<input type="text" name="lqditor_pswd"  class="form-control"  placeholder="Enter Liquitor password">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Liquiditor Address</label>
<input type="text" name="lqditor_adrs"  class="form-control"  placeholder="Enter Liquitor address">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Liquiditor Address 2</label>
<input type="text" name="lqditor_adrstw"  class="form-control"  placeholder="Enter Liquitor address">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Liquiditor City</label>
<input type="text" name="lqditor_cty"  class="form-control"  placeholder="Enter Liquitor city">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Liquiditor State</label>
<input type="text" name="lqditor_stet" class="form-control"  placeholder="Enter Liquitor State" >
</div>
...
if($qst_ad_prdt)
{
echo "<script>window.alert('Liquiditor Added Successfully');window.location='';</script>";
