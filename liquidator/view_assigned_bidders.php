...
<!--<h2 class="mt-30 page-title">View Assigned Bidders To A Asset Id</h2>-->
<ol class="breadcrumb mb-30">
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">View Assigned Bidders To A Asset Id</li>
</ol>
...
<tbody>
    ...
    <?php 
    $usr_lst="select * from assign_bidders_by_liquidator where liquidator_id='$emp_id'";
...
$cmp_nem=$clct_clt_cmp_dtl['company_name'];
    ...
    ?><tr>
        ...
        <td><a href='edit_assgned_bdder.php?id=<?php echo $iiidd;?>' class='btn btn-primary'>Edit</a> <a href='delete_assgned_bdder.php?id=<?php echo $iiidd;?>' onclick="return confirm('Are you sure want to unassigned this bidder?');" class='btn btn-danger'>Delete</a></td>
