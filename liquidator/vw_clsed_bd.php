...
<li class="breadcrumb-item active" style="font-size: 20px;font-weight: bold;color: black !important;">Closed Bid</li>
</ol>
...
?>
  ...
  <div class="card-body">
    ...
    <a href="vw_live_bidding_details.php?id=<?php echo $sls_id;?>" class="card-link btn btn-primary">View live Bid</a> <a href="vw_bid_ddtls.php?id=<?php echo $sls_id;?>" class="card-link btn btn-danger">View Bid Details</a> <br><br>
    <a href="vw_bid_report.php?id=<?php echo $sls_id;?>" class="card-link btn btn-danger">View Bid Report</a>
  </div>
</div>
<?php 
}
