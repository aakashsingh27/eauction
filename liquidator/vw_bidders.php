...
<a href='add_bidders.php' class='btn btn-primary mb-5' style="float:right"><i class="fa fa-plus" aria-hidden="true"></i> Add Bidder</a>
...
<th style="border-bottom:2px solid black !important;">Send Email</th>
...
?><tr>
        ...
        <td><?php echo $bdr_sts;?></td>
          <td><a href='sent_emnl_bdrs.php?id=<?php echo $bdr_id;?>&lqdtr_id=<?php echo $emp_id;?>' onclick="return confirm('Are you sure want to sent credentials on email to <?php echo $bdr_nem; ?>');" class='btn btn-success btn-sm' style="width:110px;"><i class="fa fa-envelope" aria-hidden="true"></i> Send Email </a> </td>
        <td><a href='edit_bdrs.php?id=<?php echo $bdr_id?>' class='btn btn-warning btn-sm' style="width: 69px;"><i class='fa fa-edit'></i> Edit</a> <a href='delete_bdrs.php?id=<?php echo $bdr_id;?>' onclick="return confirm('Are you sure want to delete this bidder?')" class='btn btn-danger btn-sm'style="width: 80px;"><i class='fa fa-trash'></i> Delete</a></td>
        </tr>
