...
//bidder credentials start
include("smtp_credentials.php");
//bidder credentials end
...
$mail->FromName = "Assign company";
$mail->AddAddress("$bddr_eeemnl");
//$mail->AddReplyTo("mail@mail.com");

$mail->IsHTML(true);

$mail->Subject = "IP Support Assign compnay to bidder datetime ($det_tem)";
$mail->Body = "<p3>Dear Applicant $bdder_nem </p3><br><br>
<p3>Greeting of the day !!</p3><br><br>
<p3>You have been approved as a bidder for ($cmp_nem company ). Auction is going to start from ($strt_tem) to ($end_tem).</p3><br><br>
<p3> <a href='https://eauction.ipsupport.in/bidder_login.php'>click here to login </a></p3><br>
<p3><b>Username :- </b> $bdder_uid</p3><br><br>
<p3><b>Password :- </b>$bdder_pswd</p3><br><br>
