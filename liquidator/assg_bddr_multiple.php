...
<li class="breadcrumb-item active" style="font-size: 18px;font-weight: bold;color: black !important;">Assign Multiple Bidders To A Asset Id</li>
</ol>
<form action='' method='POST'>
<div class='row'>
<div class='col-md-8'>
<select name='cmpy_id' id="cemp_iid" class='form-control' style="border:1px solid black !important;" required>
...
<script>
$(document).ready(function(){
$('#cemp_iid').change(function(){
var cmp_id=$('#cemp_iid').val();

$.ajax({
url: "already_assigned_bddr_ajax.php",
type: "POST",
data    : {txt1:cmp_id,txt2:<?php echo $a_idchk;?>},
cache: false,
success: function(data){
$('#bbbdddd_data').html(data);
