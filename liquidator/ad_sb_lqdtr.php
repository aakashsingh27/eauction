...
<input type='text' name="nem" placeholder='Enter name' class="form-control" maxlength="50" required style="border:1px solid black !important;">
</div>
...
<input type="email" name="emnl"  class="form-control"  placeholder="Enter Email"  maxlength="80" required style="border:1px solid black !important;">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Mobile</label>
<input type="number" name="mobile"  class="form-control"  placeholder="Enter Mobile Number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10"required style="border:1px solid black !important;">
</div>


<div class="form-group col-md-6 col-xs-6">
<label class="form-label" style="font-size:16px !important;">Password</label>
<input type="text" name="password"  min="0" class="form-control" maxlength="50" placeholder="Enter Password" required style="border:1px solid black !important;">
</div>
