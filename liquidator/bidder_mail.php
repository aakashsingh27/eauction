...
$mail->FromName = "Bidder Credentials";
$mail->AddAddress("$bdr_emml");
//$mail->AddReplyTo("mail@mail.com");

$mail->IsHTML(true);

$mail->Subject = "IP Support (Bidder Credentials)--Date-time ($crt_det_tme)";
$mail->Body = "<p3>Dear Ma’am/Sir,</p3><br><br>
<p3>Greeting of the day !!</p3><br><br>
<p3>Here is your login credentials for Bidder panel. </p3><br><br>
<p3><a href='https://eauction.ipsupport.in/bidder_login.php'>Click here - (Link)</a></p3><br><br>
<p3><span style='font-weight:bold'>Username :- </span> <span>$bdr_uiid</span></p3><br><br>
<p3><span style='font-weight:bold'>Password :- </span> <span>$bdr_pwd</span></p3><br><br>
