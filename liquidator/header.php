...
echo $usr_dtl="select * from add_liquidator where liquidator_email='$usr_eml'";
$qst_usr_dtl=$db->query($usr_dtl);
$clct_usr_dtl=$qst_usr_dtl->fetch_assoc();


$emp_id=$clct_usr_dtl['id'];
$usr_nme=$clct_usr_dtl['liquidator_name'];
?>
...
<button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i onclick="myFunction()" class="fas fa-bars"></i></button>
  ...
  <a class="navbar-brand logo-brand" href="index.php"><span style="color: #14b214;">Welcome</span> <?php echo $usr_nme?></a>
...
<a class="nav-link collapsed" href="vw_asgn_cmpy.php">
<div class="sb-nav-link-icon"><i class="fas fa-newspaper"></i></div>
Assigned Asset Id
<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
</a>
...
<nav class="sb-sidenav-menu-nested nav">
<a class="nav-link sub_nav_link" href="assign_bidder_to_a_company.php">Assign Bidders To Asset Id</a>
<a class="nav-link sub_nav_link" href="assg_bddr_multiple.php">Assign Multiple Bidders To Asset Id</a>
<a class="nav-link sub_nav_link" href="view_assigned_bidders.php">View Assigned Bidders to Asset Id</a>
...
<a class="nav-link collapsed" href="vw_livebidding.php" >
<div class="sb-nav-link-icon"><i class="fas fa-newspaper"></i></div>
Live Bids
<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
</a>
...
<a class="nav-link collapsed" href="view_upcmng.php">
<div class="sb-nav-link-icon"><i class="fas fa-newspaper"></i></div>
Upcoming Bids
<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
</a>
...
<a class="nav-link collapsed" href="vw_clsed_bd.php" >
<div class="sb-nav-link-icon"><i class="fas fa-newspaper"></i></div>
Closed Bid
<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
</a>
