   ...
   if($qst_assgn_usr)
   {
       ...
       if($qst_upd_bbddrs)
       {
        // include('bidder_request_approved_mail.php');
           echo "<script>window.alert('bidders is approved for this notice');window.location='view_bdr_rqst.php';</script>";
       }
   }
}
else
{
    //include('bidder_request_approved_mail.php');
    echo "<script>window.alert('This company is already assigned to this bidder');window.location='view_bdr_rqst.php';</script>";
}
